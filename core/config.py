...
# 1 Star ≈ $0.01-0.02 залежно від регіону покупки. Довші плани — вигідніші
# за ціною одного дня, щоб стимулювати купувати більше одразу.
STAR_PRICE_WEEK = _int("STAR_PRICE_WEEK", 59)
STAR_PRICE_MONTH = _int("STAR_PRICE_MONTH", 149)
STAR_PRICE_3MONTH = _int("STAR_PRICE_3MONTH", 379)
